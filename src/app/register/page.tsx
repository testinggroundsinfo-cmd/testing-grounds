  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-white/10 bg-ink-800 p-8 shadow-panel">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        <input name="full_name" required placeholder="Nome visualizzato" className="w-full rounded-lg border border-white/10 bg-ink-900 px-3 py-2" />
        <input name="username" required minLength={3} maxLength={24} pattern="[a-zA-Z0-9_]+" placeholder="Username" className="w-full rounded-lg border border-white/10 bg-ink-900 px-3 py-2" />
        ...
        <button className="rounded-lg bg-accent px-4 py-2 text-sm font-semibold text-ink-950">Crea account</button>
